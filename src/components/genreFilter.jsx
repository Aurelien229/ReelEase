...
const GenreFilter = ({ selectedGenre, onGenreChange }) => {
  ...
  <div className="mb-8 text-center text-lg">
    ...
    <select id="genre-select" value={selectedGenre} onChange={(e) => onGenreChange(e.target.value)} className="bg-white border border-gray-300 rounded-md px-4 py-2 focus:outline-none focus:border-[#2092a4] text-center font_1">
